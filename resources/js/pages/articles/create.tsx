...
export default function CreateArticle() {
    ...
    return (
        <AppShell>
            <Head title="Buat Artikel Baru - CyberTech News" />
            ...
            <div className="p-6">
                ...
                <div className="flex items-center space-x-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Tulis artikel tentang keamanan siber</p>
                    </div>
                </div>
...
- Sertakan contoh konkret dan studi kasus
- Gunakan bahasa yang mudah dipahami"
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                >
                                    ...
                                    <span>{processing ? 'Menyimpan...' : 'Simpan Artikel'}</span>
                                </Button>
                                <Link href="/manage/articles">
